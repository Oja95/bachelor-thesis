...
\TODO{Describe that having more samples somewhat also solves this problem}
\TODO{Is necessary to explain offseting interval more indepth?}
...
\TODO{Needs better (or another) citation on profile change due to optimizations change. The citation mentioned: "[..] a profiler may perturb the program being optimized and thus change its profile"}
\TODO{Perhaps can construct an illustrative example for these problems?}


\subsection{Sampling profiling advantages compared to alternatives}
